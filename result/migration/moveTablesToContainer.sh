 ...
 *****************************/
EXEC 'ALTER TABLE "LM"."LM::EPM.MapKeys" OWNER TO $container_owner';
EXEC 'RENAME TABLE "LM"."LM::EPM.MapKeys" TO "$container_name"."LM::EPM.MapKeys"';

EXEC 'ALTER TABLE "LM"."LM::TABLES.CUST_REV_CDS" OWNER TO $container_owner';
EXEC 'RENAME TABLE "LM"."LM::TABLES.CUST_REV_CDS" TO "$container_name"."LM::TABLES.CUST_REV_CDS"';
