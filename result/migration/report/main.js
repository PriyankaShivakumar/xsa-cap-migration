...
function createMigrationStepListArea(e, t, a, n) {
  ...
  for (var i = [], r = [], l = 0; l < a.length; l++)
    i.push(a[l].text), r.push(a[l].value);
  var o =
    getStepInfoText(i, r, n) +
    generateTag("a", {
      id: t + "listlink",
      text: "Detail List",
      properties: [
...
function initAsyncMigratorView(e, t){
  ...
  asyncWarnings.forEach((warning, index) => {
    if (index == 2 || index == 3 || index == 4) {
      asyncWarnings[index] = "<span style='color: #D89000;'>" + warning + "</span>";
    }
  });
...
function initSummaryView(e, t) {
  ...
  (n +=
    ...
    a.names.push("migration tool"),
    a.values.push(main_data["mig-tool-version"]),
  ...
  t.view && "main" != t.view
    ...
    : (createTitle("#content", "mainview_title", tool_name, {
      ...
      createTabs(
        "#content",
        "mainview_tabs",
        ["Summary", "File statistics", "File List", "Steps Detail", "Async Migration"],
        [
          e + "_summaryTab",
          e + "_statisticsTab",
          e + "_FilesTab",
