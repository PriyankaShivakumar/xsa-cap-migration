...
const hanaDbConnection = async() => {
    ...
    try {
        ...
        console.log('hdb-client-helper prepareAndConnect Error:' + error.message);
    }
...
const disconnectConnection = async() =>{
    try {
        ...
        console.log('hdb-client-helper disconnect Error', error);
    }
}
module.exports = {hanaDbConnection,disconnectConnection,connection}
